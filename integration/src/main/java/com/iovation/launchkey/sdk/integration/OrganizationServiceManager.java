...
public class OrganizationServiceManager {
    ...
    ServiceEntity getCurrentServiceEntity() {
    ...
    ServiceEntity getPreviousServiceEntity() {
    ...
    void createService(String name, String description, URI icon, URI callbackURL, Boolean active)
            throws Throwable {
    ...
    void createService(String name) throws Throwable {
        createService(name, null, null, null, true);
    }

    void createService() throws Throwable {
        createService(Utils.createRandomServiceName());
    }

    void createService(String description, URI icon, URI callbackUrl, Boolean active) throws Throwable {
        createService(Utils.createRandomServiceName(), description, icon, callbackUrl, active);
    }

    void retrieveCurrentService() throws Throwable {
        retrieveService(currentServiceEntity.getId());
    }

    void retrieveService(UUID serviceId) throws Throwable {
    ...
    void updateService(UUID serviceId, String description, URI icon, URI callbackUrl, Boolean active) throws Throwable {
        updateService(serviceId, getCurrentServiceEntity().getName(), description, icon, callbackUrl, active);
    }

    void retrieveServices(List<UUID> serviceIds) throws Throwable {
    ...
    void retrieveAllServices() throws Throwable {
        List<ServiceEntity> services = new ArrayList<>();
    ...
    void addPublicKeyToCurrentService(UUID serviceId, RSAPublicKey publicKey, Boolean active, Date expires) throws Throwable {
    ...
    void addPublicKeyToCurrentService(RSAPublicKey publicKey, Boolean active, Date expires) throws Throwable {
        addPublicKeyToCurrentService(getCurrentServiceEntity().getId(), publicKey, active, expires);
    }

    void updatePublicKey(UUID serviceId, String keyId, Boolean active, Date expires) throws Throwable{
    ...
    void retrieveCurrentServicePublicKeysList() throws Throwable {
        retrieveServicePublicKeysList(getCurrentServiceEntity().getId());
    }

    void retrieveServicePublicKeysList(UUID serviceId) throws Throwable {
    ...
    Set<PublicKeyEntity> getCurrentServicePublicKeys() {
        return currentServicePublicKeys;
    }

    void removePublicKey(UUID serviceId, String keyId) throws Throwable {
