...
public class OrganizationServicePolicySteps {
    ...
    public void theOrganizationServicePolicyIsSetToHaveTheFollowingTimeFences(List<ServicePolicyEntity.TimeFence> timeFences) throws Throwable {
        organizationServicePolicyManager.getCurrentServicePolicyEntity().getTimeFences().addAll(timeFences);
    }

    @Given("^the Organization Service Policy has the following Time Fences:$")
    public void theOrganizationServicePolicyHasTheFollowingTimeFences(List<ServicePolicyEntity.TimeFence> timeFences) throws Throwable {
        assertThat(organizationServicePolicyManager.getCurrentServicePolicyEntity().getTimeFences(), is(equalTo(timeFences)));
    }

    @Given("^the Organization Service Policy is set to have the following Geofence locations:$")
    public void theOrganizationServicePolicyIsSetToHaveTheFollowingGeofenceLocations(List<ServicePolicyEntity.Location> locations) throws Throwable {
        organizationServicePolicyManager.getCurrentServicePolicyEntity().getLocations().addAll(locations);
    }

    @Given("^the Organization Service Policy has the following Geofence locations:$")
    public void theOrganizationServicePolicyHasTheFollowingGeofenceLocations(List<ServicePolicyEntity.Location> locations) throws Throwable {
        assertThat(organizationServicePolicyManager.getCurrentServicePolicyEntity().getLocations(), is(equalTo(locations)));
    }
}
