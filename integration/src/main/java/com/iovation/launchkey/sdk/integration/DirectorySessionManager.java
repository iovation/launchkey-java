...
public class DirectorySessionManager {
    ...
    void retrieveSessionList(String userIdentifier) throws Throwable {
    ...
    List<SessionEntity> getCurrentSessionList() {
        return currentSessionList;
    }

    void endAllSessionsForUser(String userIdentifier) throws Throwable {
