...
public class DirectoryServiceManager {
    ...
    UUID createService(UUID directoryId, String name) throws Throwable {
        return createService(directoryId, name, null, null, null, true);
    }

    UUID createService(UUID directoryId) throws Throwable {
        return createService(directoryId, Utils.createRandomServiceName());
    }

    UUID createService(UUID directoryId, String description, URI icon, URI callbackUrl, Boolean active)
            throws Throwable {
    ...
    void retrieveService(UUID directoryId, UUID serviceId) throws Throwable {
        Service service = getClient(directoryId).getService(serviceId);
        previousServiceEntity = currentServiceEntity;
        currentServiceEntity = ServiceEntity.fromService(service);
    }

    void retrieveCurrentService(UUID directoryId) throws Throwable {
    ...
    void addPublicKeyToService(UUID directoryId, UUID serviceId, RSAPublicKey publicKey, Boolean active, Date expires)
            throws Throwable {
        getClient(directoryId).addServicePublicKey(serviceId, publicKey, active, expires);
    }


    void addPublicKeyToCurrentService(UUID directoryId, RSAPublicKey publicKey, Boolean active, Date expires)
            throws Throwable {
    ...
    void updatePublicKey(UUID directoryId, UUID serviceId, String keyId, Boolean active, Date expires)
            throws Throwable {
        getClient(directoryId).updateServicePublicKey(serviceId, keyId, active, expires);
    }

    void retrievePublicKeysList(UUID directoryId, UUID serviceId) throws Throwable {
    ...
    void removePublicKey(UUID directoryId, UUID serviceId, String keyId) throws Throwable {
        getClient(directoryId).removeServicePublicKey(serviceId, keyId);
    }

    void updateService(UUID directoryId, UUID serviceId, String description, URI icon, URI callbackURL,
                       Boolean active) throws Throwable {
    ...
    void retrieveServices(UUID directoryId, List<UUID> serviceIds) throws Throwable {
    ...
    void retrieveAllServices(UUID directoryId) throws Throwable {
        List<ServiceEntity> services = new ArrayList<>();
