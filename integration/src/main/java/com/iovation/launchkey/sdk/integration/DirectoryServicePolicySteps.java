...
public class DirectoryServicePolicySteps {
    ...
    public void theDirectoryServicePolicyIsSetToHaveTheFollowingTimeFences(List<ServicePolicyEntity.TimeFence> timeFences) throws Throwable {
        directoryServicePolicyManager.getCurrentServicePolicyEntity().getTimeFences().addAll(timeFences);
    }

    @Given("^the Directory Service Policy has the following Time Fences:$")
    public void theDirectoryServicePolicyHasTheFollowingTimeFences(List<ServicePolicyEntity.TimeFence> timeFences) throws Throwable {
        assertThat(directoryServicePolicyManager.getCurrentServicePolicyEntity().getTimeFences(), is(equalTo(timeFences)));
    }

    @Given("^the Directory Service Policy is set to have the following Geofence locations:$")
    public void theDirectoryServicePolicyIsSetToHaveTheFollowingGeofenceLocations(List<ServicePolicyEntity.Location> locations) throws Throwable {
        directoryServicePolicyManager.getCurrentServicePolicyEntity().getLocations().addAll(locations);
    }

    @Given("^the Directory Service Policy has the following Geofence locations:$")
    public void theDirectoryServicePolicyHasTheFollowingGeofenceLocations(List<ServicePolicyEntity.Location> locations) throws Throwable {
        assertThat(directoryServicePolicyManager.getCurrentServicePolicyEntity().getLocations(), is(equalTo(locations)));
    }
}
