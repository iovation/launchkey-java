...
class KeysManager {
    ...
    String getBase64EncodedAlphaP12() throws IOException {
    ...
    String getBase64EncodedBetaP12() throws IOException {
    ...
    String getAlphaCertificateFingerprint() throws IOException {
    ...
    String getBetaCertificateFingerprint() throws IOException {
    ...
    RSAPublicKey getAlphaPublicKey() throws IOException {
    ...
    RSAPublicKey getBetaPublicKey() throws IOException {
    ...
    String getAlphaPublicKeyMD5Fingerprint() throws IOException {
    ...
    String getBetaPublicKeyMD5Fingerprint() throws IOException {
