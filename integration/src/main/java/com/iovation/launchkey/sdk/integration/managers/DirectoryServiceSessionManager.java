...
public class DirectoryServiceSessionManager {
    ...
    public void startSession(UUID serviceId, String userIdentifier) throws Throwable {
        getServiceClient(serviceId).sessionStart(userIdentifier);
    }

    public void startSession(UUID serviceId, String userIdentifier, String authRequestId) throws Throwable {
        getServiceClient(serviceId).sessionStart(userIdentifier, authRequestId);
    }

    public void endSession(UUID serviceId, String userIdentifier) throws Throwable {
