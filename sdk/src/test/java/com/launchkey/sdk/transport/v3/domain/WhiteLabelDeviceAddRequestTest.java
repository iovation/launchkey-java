 ...
 */
public class WhiteLabelDeviceAddRequestTest {
    private static final String ISSUER = "Issuer";
    private static final String SDK_KEY = "SDK Key";
    private static final String IDENTIFIER = "Identifier";
    private WhiteLabelDeviceAddRequest request;
    private RSAPrivateKey privateKey;

    @Before
    public void setUp() throws Exception {
        privateKey = (RSAPrivateKey) KeyPairGenerator.getInstance("RSA").generateKeyPair().getPrivate();
        request = new WhiteLabelDeviceAddRequest(privateKey, ISSUER, SDK_KEY, IDENTIFIER);
    }
    ...
    public void hashCodeIsTheSameForEquivalentObject() throws Exception {
        assertEquals(request.hashCode(), new WhiteLabelDeviceAddRequest(privateKey, ISSUER, SDK_KEY, IDENTIFIER).hashCode());
    }

    @Test
    public void hashCodeIsDifferentForDifferentPublicKey() throws Exception {
        assertNotEquals(request.hashCode(), new WhiteLabelDeviceAddRequest((RSAPrivateKey) KeyPairGenerator.getInstance("RSA").generateKeyPair().getPrivate(), ISSUER, SDK_KEY, IDENTIFIER).hashCode());
    }

    @Test
    public void hashCodeIsDifferentForDifferentIssuer() throws Exception {
        assertNotEquals(request.hashCode(), new WhiteLabelDeviceAddRequest(privateKey, "Other Issuer", SDK_KEY, IDENTIFIER).hashCode());
    }

    @Test
    public void hashCodeIsDifferentForDifferentSdkKey() throws Exception {
        assertNotEquals(request.hashCode(), new WhiteLabelDeviceAddRequest(privateKey, ISSUER, "Other SDK Key", IDENTIFIER).hashCode());
    }


    @Test
    public void hashCodeIsDifferentForDifferentIdentifier() throws Exception {
        assertNotEquals(request.hashCode(), new WhiteLabelDeviceAddRequest(privateKey, ISSUER, SDK_KEY, "Other Identifier").hashCode());
    }
    ...
    public void equalsIsTrueForEquivalentObject() throws Exception {
        assertTrue(request.equals(new WhiteLabelDeviceAddRequest(privateKey, ISSUER, SDK_KEY, IDENTIFIER)));
    }

    @Test
    public void equalsIsFalseForDifferentPublicKey() throws Exception {
        assertFalse(request.equals(new WhiteLabelDeviceAddRequest((RSAPrivateKey) KeyPairGenerator.getInstance("RSA").generateKeyPair().getPrivate(), ISSUER, SDK_KEY, IDENTIFIER)));
    }

    @Test
    public void equalsIsFalseForDifferentIssuer() throws Exception {
        assertFalse(request.equals(new WhiteLabelDeviceAddRequest(privateKey, "Different Issuer", SDK_KEY, IDENTIFIER)));
    }

    @Test
    public void equalsIsFalseForDifferentSdkKey() throws Exception {
        assertFalse(request.equals(new WhiteLabelDeviceAddRequest(privateKey, ISSUER, "Different SDK Key", IDENTIFIER)));
    }


    @Test
    public void equalsIsFalseForDifferentIdentifier() throws Exception {
        assertFalse(request.equals(new WhiteLabelDeviceAddRequest(privateKey, ISSUER, SDK_KEY, "Different Identifier")));
    }
