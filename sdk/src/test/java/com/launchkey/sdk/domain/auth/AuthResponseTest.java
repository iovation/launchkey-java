...
public class AuthResponseTest {
    ...
    private com.launchkey.sdk.service.auth.AuthResponse authResponse;

    @Before
    public void setUp() throws Exception {
        authResponse = new com.launchkey.sdk.service.auth.AuthResponse(
                "Auth Request ID",
                true,
                "User Hash",
    ...
    public void testEqualsForEqualObjectsIsTrue() throws Exception {
        com.launchkey.sdk.service.auth.AuthResponse left = new com.launchkey.sdk.service.auth.AuthResponse(null, true, null, null, null, null);
        com.launchkey.sdk.service.auth.AuthResponse right = new com.launchkey.sdk.service.auth.AuthResponse(null, true, null, null, null, null);
        assertTrue(left.equals(right));
    }

    @Test
    public void testEqualsForUnEqualObjectsIsFalse() throws Exception {
        com.launchkey.sdk.service.auth.AuthResponse left = new com.launchkey.sdk.service.auth.AuthResponse("left", true, null, null, null, null);
        com.launchkey.sdk.service.auth.AuthResponse right = new com.launchkey.sdk.service.auth.AuthResponse("right", true, null, null, null, null);
