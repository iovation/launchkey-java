...
public class ApacheHttpTransportOrganizationV3ServicesListPostTest extends ApacheHttpTransportTestBase {
    @Mock
    ...
    public void sendsRequestWithProperMethodAndPath() throws Exception {
        transport.organizationV3ServicesListPost(servicesListPostRequest, entityIdentifier);
        verifyCall("POST", URI.create(baseUrl.concat("/organization/v3/services/list")));
    }
