...
public class ApacheHttpTransportOrganizationV3ServicePolicyPutTest extends ApacheHttpTransportTestBase {
    @Mock
    ...
    public void sendsRequestWithProperMethodAndPath() throws Exception {
        transport.organizationV3ServicePolicyPut(request, entityIdentifier);
        verifyCall("PUT", URI.create(baseUrl.concat("/organization/v3/service/policy")));
    }
