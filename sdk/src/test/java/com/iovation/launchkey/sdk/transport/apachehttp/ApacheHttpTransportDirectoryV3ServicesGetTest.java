...
public class ApacheHttpTransportDirectoryV3ServicesGetTest extends ApacheHttpTransportTestBase {
    @Mock
    ...
    public void sendsRequestWithProperMethodAndPath() throws Exception {
        transport.directoryV3ServicesGet(entityIdentifier);
        verifyCall("GET", URI.create(baseUrl.concat("/directory/v3/services")));
    }
    ...
    public void responseIsParsedProperlyAndReturned() throws Exception {
        ...
        ServicesGetResponse actual = transport.directoryV3ServicesGet(entityIdentifier);
