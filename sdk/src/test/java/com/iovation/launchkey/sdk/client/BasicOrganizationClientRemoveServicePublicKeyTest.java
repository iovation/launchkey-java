...
public class BasicOrganizationClientRemoveServicePublicKeyTest {
    ...
    public void sendsSubjectEntityType() throws Exception {
        ...
        verify(transport).organizationV3ServiceKeysDelete(any(ServiceKeysDeleteRequest.class), entityCaptor.capture());
    ...
    public void sendServiceIdInRequest() throws Exception {
        ...
        verify(transport).organizationV3ServiceKeysDelete(requestCaptor.capture(), any(EntityIdentifier.class));
