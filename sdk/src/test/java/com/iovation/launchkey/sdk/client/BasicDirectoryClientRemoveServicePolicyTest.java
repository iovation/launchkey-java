...
public class BasicDirectoryClientRemoveServicePolicyTest {
    @Mock
    ...
    public void sendsSubjectEntityType() throws Exception {
        ...
        verify(transport).directoryV3ServicePolicyDelete(any(ServicePolicyDeleteRequest.class), entityCaptor.capture());
    ...
    public void sendsServiceId() throws Exception {
        client.removeServicePolicy(serviceId);
        verify(transport).directoryV3ServicePolicyDelete(requestCaptor.capture(), any(EntityIdentifier.class));
