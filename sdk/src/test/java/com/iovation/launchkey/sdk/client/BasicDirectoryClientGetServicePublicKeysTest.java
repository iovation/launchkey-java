...
public class BasicDirectoryClientGetServicePublicKeysTest {
    ...
    public void setUp() throws Exception {
        ...
        when(transport
                .directoryV3ServiceKeysListPost(any(ServiceKeysListPostRequest.class), any(EntityIdentifier.class)))
                .thenReturn(response);
    ...
    public void sendsSubjectEntityType() throws Exception {
        ...
        verify(transport)
                .directoryV3ServiceKeysListPost(any(ServiceKeysListPostRequest.class), entityCaptor.capture());
    ...
    public void sendsServiceIdInRequest() throws Exception {
        client.getServicePublicKeys(serviceId);
        verify(transport).directoryV3ServiceKeysListPost(requestCaptor.capture(), any(EntityIdentifier.class));
    }
