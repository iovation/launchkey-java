...
public class ApacheHttpTransportDirectoryV3ServicesPostTest extends ApacheHttpTransportTestBase {
    @Mock
    ...
    public void sendsRequestWithProperMethodAndPath() throws Exception {
        transport.directoryV3ServicesPost(servicesPostRequest, entityIdentifier);
        verifyCall("POST", URI.create(baseUrl.concat("/directory/v3/services")));
    }
    ...
    public void parsedResponseIsReturned() throws Exception {
        ...
        ServicesPostResponse actual = transport.directoryV3ServicesPost(servicesPostRequest, entityIdentifier);
