 ...
 */
public class NoLinkedDevicesExceptionTest {
    ...
    public void constructorMessageCauseErrorCode() throws Exception {
        NoLinkedDevicesException exception = new NoLinkedDevicesException(MESSAGE, CAUSE, CODE);
    ...
    public void equalsIsTrueForEquivalentObject() throws Exception {
        NoLinkedDevicesException base = new NoLinkedDevicesException(MESSAGE, CAUSE, CODE);
        NoLinkedDevicesException other = new NoLinkedDevicesException(MESSAGE, CAUSE, CODE);
    ...
    public void equalsIsFalseForDifferentMessage() throws Exception {
        NoLinkedDevicesException base = new NoLinkedDevicesException(MESSAGE, CAUSE, CODE);
        NoLinkedDevicesException other = new NoLinkedDevicesException(null, CAUSE, CODE);
    ...
    public void equalsIsFalseForDifferentCause() throws Exception {
        NoLinkedDevicesException base = new NoLinkedDevicesException(MESSAGE, CAUSE, CODE);
        NoLinkedDevicesException other = new NoLinkedDevicesException(MESSAGE, null, CODE);
        assertFalse(base.equals(other));
    }
    ...
    public void equalsIsFalseForDifferentErrorCode() throws Exception {
        NoLinkedDevicesException base = new NoLinkedDevicesException(MESSAGE, CAUSE, CODE);
        NoLinkedDevicesException other = new NoLinkedDevicesException(MESSAGE, CAUSE, null);
        assertFalse(base.equals(other));
    }
    ...
    public void toStringContainsClassName() throws Exception {
        assertTrue(new NoLinkedDevicesException(MESSAGE, CAUSE, CODE).toString().contains(NoLinkedDevicesException.class.getSimpleName()));
    }
}
