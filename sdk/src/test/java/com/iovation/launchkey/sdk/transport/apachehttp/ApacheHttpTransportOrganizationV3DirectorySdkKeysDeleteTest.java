...
public class ApacheHttpTransportOrganizationV3DirectorySdkKeysDeleteTest extends ApacheHttpTransportTestBase {
    @Mock
    private OrganizationV3DirectorySdkKeysDeleteRequest request;
    ...
    public void sendsRequestWithProperMethodAndPath() throws Exception {
        transport.organizationV3DirectorySdkKeysDelete(request, entityIdentifier);
        verifyCall("DELETE", URI.create(baseUrl.concat("/organization/v3/directory/sdk-keys")));
    }
