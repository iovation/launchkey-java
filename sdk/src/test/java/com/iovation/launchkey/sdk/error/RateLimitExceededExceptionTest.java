...
public class RateLimitExceededExceptionTest {
    ...
    public void constructorMessageCauseErrorCode() throws Exception {
        RateLimitExceededException exception = new RateLimitExceededException(MESSAGE, CAUSE, CODE);
    ...
    public void equalsIsTrueForEquivalentObject() throws Exception {
        RateLimitExceededException base = new RateLimitExceededException(MESSAGE, CAUSE, CODE);
        RateLimitExceededException other = new RateLimitExceededException(MESSAGE, CAUSE, CODE);
    ...
    public void equalsIsFalseForDifferentMessage() throws Exception {
        RateLimitExceededException base = new RateLimitExceededException(MESSAGE, CAUSE, CODE);
        RateLimitExceededException other = new RateLimitExceededException(null, CAUSE, CODE);
    ...
    public void equalsIsFalseForDifferentCause() throws Exception {
        RateLimitExceededException base = new RateLimitExceededException(MESSAGE, CAUSE, CODE);
        RateLimitExceededException other = new RateLimitExceededException(MESSAGE, null, CODE);
        assertFalse(base.equals(other));
    }
    ...
    public void equalsIsFalseForDifferentErrorCode() throws Exception {
        RateLimitExceededException base = new RateLimitExceededException(MESSAGE, CAUSE, CODE);
        RateLimitExceededException other = new RateLimitExceededException(MESSAGE, CAUSE, null);
        assertFalse(base.equals(other));
    }
    ...
    public void toStringContainsClassName() throws Exception {
        assertTrue(new RateLimitExceededException(MESSAGE, CAUSE, CODE).toString().contains(RateLimitExceededException.class.getSimpleName()));
    }
}
