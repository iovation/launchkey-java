...
public class ApacheHttpTransportDirectoryV3ServiceKeysPatchTest extends ApacheHttpTransportTestBase {
    @Mock
    ...
    public void sendsRequestWithProperMethodAndPath() throws Exception {
        transport.directoryV3ServiceKeysPatch(serviceKeysPatchRequest, entityIdentifier);
        verifyCall("PATCH", URI.create(baseUrl.concat("/directory/v3/service/keys")));
    }
