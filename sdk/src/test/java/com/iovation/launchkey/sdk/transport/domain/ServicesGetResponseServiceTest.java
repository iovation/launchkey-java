...
public class ServicesGetResponseServiceTest {
    private ServicesGetResponseService response;

    @Before
    public void setUp() throws Exception {
        response = new ServicesGetResponseService(UUID.fromString("fac25a3c-af79-49df-bd65-777e9c86e288"), "Expected Name",
    ...
    public void getId() throws Exception {
        assertEquals(UUID.fromString("fac25a3c-af79-49df-bd65-777e9c86e288"), response.getId());
    }

    @Test
    public void getIcon() throws Exception {
        assertEquals(URI.create("https://foo.bar"), response.getIcon());
    }
    ...
    public void getCallbackUrl() throws Exception {
        assertEquals(URI.create("https://fizz.buzz"), response.getCallbackURL());
    }
