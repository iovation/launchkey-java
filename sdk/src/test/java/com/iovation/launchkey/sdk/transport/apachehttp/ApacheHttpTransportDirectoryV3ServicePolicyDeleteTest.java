...
public class ApacheHttpTransportDirectoryV3ServicePolicyDeleteTest extends ApacheHttpTransportTestBase {
    @Mock
    ...
    public void sendsRequestWithProperMethodAndPath() throws Exception {
        transport.directoryV3ServicePolicyDelete(request, entityIdentifier);
        verifyCall("DELETE", URI.create(baseUrl.concat("/directory/v3/service/policy")));
    }
