...
public class ApacheHttpTransportDirectoryV3ServiceKeysListPostTest extends ApacheHttpTransportTestBase {
    ...
    public void sendsRequestWithProperMethodAndPath() throws Exception {
        transport.directoryV3ServiceKeysListPost(serviceKeysListPostRequest, entityIdentifier);
        verifyCall("POST", URI.create(baseUrl.concat("/directory/v3/service/keys/list")));
    }
