...
public class BasicOrganizationClientUpdateServicePublicKeyTest {
    @Mock
    ...
    public void sendsSubjectEntityType() throws Exception {
        ...
        verify(transport)
                .organizationV3ServiceKeysPatch(any(ServiceKeysPatchRequest.class), entityCaptor.capture());
    ...
    public void sendsServiceIdInRequest() throws Exception {
        client.updateServicePublicKey(serviceId, null, false, null);
        verify(transport).organizationV3ServiceKeysPatch(requestCaptor.capture(), any(EntityIdentifier.class));
