...
public class ApacheHttpTransportDirectoryV3ServiceKeysDeleteTest extends ApacheHttpTransportTestBase {
    @Mock
    ...
    public void sendsRequestWithProperMethodAndPath() throws Exception {
        transport.directoryV3ServiceKeysDelete(request, entityIdentifier);
        verifyCall("DELETE", URI.create(baseUrl.concat("/directory/v3/service/keys")));
    }
