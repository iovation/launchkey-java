...
public class BasicDirectoryClientUpdateServiceTest {
    ...
    public void sendsSubjectEntityType() throws Exception {
        ...
        verify(transport).directoryV3ServicesPatch(any(ServicesPatchRequest.class), entityCaptor.capture());
    ...
    public void sendsServiceId() throws Exception {
        ...
        verify(transport).directoryV3ServicesPatch(requestCaptor.capture(), any(EntityIdentifier.class));
