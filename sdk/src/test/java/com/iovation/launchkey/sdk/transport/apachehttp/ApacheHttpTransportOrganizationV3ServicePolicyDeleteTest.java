...
public class ApacheHttpTransportOrganizationV3ServicePolicyDeleteTest extends ApacheHttpTransportTestBase {
    @Mock
    private ServicePolicyDeleteRequest request;
    ...
    public void sendsRequestWithProperMethodAndPath() throws Exception {
        transport.organizationV3ServicePolicyDelete(request, entityIdentifier);
        verifyCall("DELETE", URI.create(baseUrl.concat("/organization/v3/service/policy")));
    }
