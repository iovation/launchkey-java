...
public class BasicOrganizationClientAddServicePublicKeyTest {
    ...
    public void setUp() throws Exception {
        ...
        when(transport.organizationV3ServiceKeysPost(any(ServiceKeysPostRequest.class), any(EntityIdentifier.class)))
                .thenReturn(response);
    }
    ...
    public void sendsSubjectEntityType() throws Exception {
        ...
        verify(transport).organizationV3ServiceKeysPost(any(ServiceKeysPostRequest.class), entityCaptor.capture());
    ...
    public void sendServiceIdInRequest() throws Exception {
        ...
        verify(transport).organizationV3ServiceKeysPost(requestCaptor.capture(), any(EntityIdentifier.class));
