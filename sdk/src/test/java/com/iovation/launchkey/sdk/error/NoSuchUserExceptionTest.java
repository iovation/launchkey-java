...
public class NoSuchUserExceptionTest {
    ...
    public void constructorMessageCauseErrorCode() throws Exception {
        NoSuchUserException exception = new NoSuchUserException(MESSAGE, CAUSE, CODE);
    ...
    public void equalsIsTrueForSameObject() throws Exception {
        NoSuchUserException base = new NoSuchUserException(MESSAGE, CAUSE, CODE);
        NoSuchUserException other = base;
    ...
    public void equalsIsTrueForEquivalentObject() throws Exception {
        NoSuchUserException base = new NoSuchUserException(MESSAGE, CAUSE, CODE);
        NoSuchUserException other = new NoSuchUserException(MESSAGE, CAUSE, CODE);
        assertTrue(base.equals(other));
    }
    ...
    public void equalsIsFalseForDifferentMessage() throws Exception {
        NoSuchUserException base = new NoSuchUserException(MESSAGE, CAUSE, CODE);
        NoSuchUserException other = new NoSuchUserException(null, CAUSE, CODE);
    ...
    public void equalsIsFalseForDifferentCause() throws Exception {
        NoSuchUserException base = new NoSuchUserException(MESSAGE, CAUSE, CODE);
        NoSuchUserException other = new NoSuchUserException(MESSAGE, null, CODE);
        assertFalse(base.equals(other));
    }
    ...
    public void equalsIsFalseForDifferentErrorCode() throws Exception {
        NoSuchUserException base = new NoSuchUserException(MESSAGE, CAUSE, CODE);
        NoSuchUserException other = new NoSuchUserException(MESSAGE, CAUSE, null);
        assertFalse(base.equals(other));
    }
    ...
    public void toStringContainsClassName() throws Exception {
        assertTrue(new NoSuchUserException(MESSAGE, CAUSE, CODE).toString().contains(NoSuchUserException.class.getSimpleName()));
    }
}
