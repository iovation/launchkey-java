...
public class ApacheHttpTransportOrganizationV3ServiceKeysDeleteTest extends ApacheHttpTransportTestBase {
    @Mock
    private ServiceKeysDeleteRequest request;
    ...
    public void sendsRequestWithProperMethodAndPath() throws Exception {
        transport.organizationV3ServiceKeysDelete(request, entityIdentifier);
        verifyCall("DELETE", URI.create(baseUrl.concat("/organization/v3/service/keys")));
    }
