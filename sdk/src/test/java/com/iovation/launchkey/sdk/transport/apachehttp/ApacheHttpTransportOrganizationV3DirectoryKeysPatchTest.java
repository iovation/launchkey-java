...
public class ApacheHttpTransportOrganizationV3DirectoryKeysPatchTest extends ApacheHttpTransportTestBase {
    @Mock
    private OrganizationV3DirectoryKeysPatchRequest request;
    ...
    public void sendsRequestWithProperMethodAndPath() throws Exception {
        transport.organizationV3DirectoryKeysPatch(request, entityIdentifier);
        verifyCall("PATCH", URI.create(baseUrl.concat("/organization/v3/directory/keys")));
    }
