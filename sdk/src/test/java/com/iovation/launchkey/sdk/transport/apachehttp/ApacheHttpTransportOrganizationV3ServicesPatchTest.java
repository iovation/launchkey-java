...
public class ApacheHttpTransportOrganizationV3ServicesPatchTest extends ApacheHttpTransportTestBase {
    @Mock
    ...
    public void sendsRequestWithProperMethodAndPath() throws Exception {
        transport.organizationV3ServicesPatch(servicesPatchRequest, entityIdentifier);
        verifyCall("PATCH", URI.create(baseUrl.concat("/organization/v3/services")));
    }
