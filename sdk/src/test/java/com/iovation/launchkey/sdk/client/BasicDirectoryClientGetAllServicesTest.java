...
public class BasicDirectoryClientGetAllServicesTest {
    ...
    public void setUp() throws Exception {
        ...
        when(transport.directoryV3ServicesGet(any(EntityIdentifier.class)))
                .thenReturn(response);
    ...
    public void sendsSubjectEntityType() throws Exception {
        ...
        verify(transport).directoryV3ServicesGet(entityCaptor.capture());
