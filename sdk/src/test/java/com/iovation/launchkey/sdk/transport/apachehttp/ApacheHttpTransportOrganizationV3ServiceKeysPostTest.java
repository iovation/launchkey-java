...
public class ApacheHttpTransportOrganizationV3ServiceKeysPostTest
    ...
    public void sendsRequestWithProperMethodAndPath() throws Exception {
        transport.organizationV3ServiceKeysPost(request, entityIdentifier);
        verifyCall("POST", URI.create(baseUrl.concat("/organization/v3/service/keys")));
    }
    ...
    public void parsedResponseIsReturned() throws Exception {
        ...
        KeysPostResponse actual = transport.organizationV3ServiceKeysPost(request, entityIdentifier);
