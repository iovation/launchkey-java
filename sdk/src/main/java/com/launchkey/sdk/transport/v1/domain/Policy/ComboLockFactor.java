...
public class ComboLockFactor extends Factor {
    public ComboLockFactor(boolean quickFail, FactorRequirementType requirement, int priority) {
        super(quickFail, requirement, priority);
    }

    @Override public FactorType getType() {
        return FactorType.COMBO_LOCK;
    }
