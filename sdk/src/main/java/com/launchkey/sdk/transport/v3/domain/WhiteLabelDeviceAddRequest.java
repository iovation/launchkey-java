...
/**
 * Request data for a white label device add call
 */
@JsonPropertyOrder({"sdk_key", "identifier"})
public class WhiteLabelDeviceAddRequest extends RequestAbstract {
     ...
     *                   account.
     */
    public WhiteLabelDeviceAddRequest(RSAPrivateKey privateKey, String issuer, String sdkKey, String identifier) {
    ...
    @Override public boolean equals(Object o) {
        ...
        WhiteLabelDeviceAddRequest that = (WhiteLabelDeviceAddRequest) o;
    ...
    @Override public String toString() {
        return "WhiteLabelDeviceAddRequest{" +
                "sdkKey='" + sdkKey + '\'' +
