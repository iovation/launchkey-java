...
/**
 * Interface for services providing application based authorization and user session management
 */
public interface AuthService {
     ...
     */
    String authorize(String username, String context, AuthPolicy policy) throws BaseException;
     ...
     * @throws CommunicationErrorException If there was an error communicating with the endpoint
     */
    String authorize(String username, String context) throws BaseException;
     ...
     * @throws CommunicationErrorException If there was an error communicating with the endpoint
     */
    String authorize(String username) throws BaseException;
     ...
     *               reduce the security level of the server policy.
     * @return Unique identifier for tracking status of the authorization request
     * @throws BaseException when an error occurs in the request
     */
    String login(String username, String context, AuthPolicy policy) throws BaseException;
     ...
     * @throws BaseException when an error occurs in the request
     */
    String login(String username, String context) throws BaseException;
     ...
     * @throws BaseException when an error occurs in the request
     */
    String login(String username) throws BaseException;
     ...
     * @throws BaseException when an error occurs in the request
     */
    void logout(String authRequestId) throws BaseException;
     ...
     * @throws BaseException when an error occurs in the request
     */
    AuthResponse getAuthResponse(String authRequestId) throws BaseException;
     ...
     * @throws BaseException when an error occurs in the request
     */
    CallbackResponse handleCallback(Map<String, String> callbackData, int signatureTimeThreshold) throws BaseException;
}
