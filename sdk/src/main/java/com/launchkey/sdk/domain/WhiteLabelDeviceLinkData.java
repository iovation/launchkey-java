...
public class WhiteLabelDeviceLinkData {
    /**
     ...
     */
    @JsonCreator
    public WhiteLabelDeviceLinkData(@JsonProperty(value = "code", required = true) String code, @JsonProperty(value = "qrcode", required = true) String qrCodeUrl) {
        this.code = code;
    ...
    @Override public String toString() {
        return "WhiteLabelDeviceLinkData{" +
                "code='" + code + '\'' +
                ", qrCodeUrl='" + qrCodeUrl + '\'' +
                '}';
    }
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof WhiteLabelDeviceLinkData)) return false;

        WhiteLabelDeviceLinkData that = (WhiteLabelDeviceLinkData) o;
