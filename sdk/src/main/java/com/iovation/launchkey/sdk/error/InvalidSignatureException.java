...
/**
 * Exception thrown when the signature in a message received from the Platform API has an invalid signature
 */
public class InvalidSignatureException extends BaseException {
     ...
     */
    public InvalidSignatureException(String message, Throwable cause, String errorCode) {
