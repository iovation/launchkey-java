...
public class AuthorizationResponse {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getAuthorizationRequestId(), isAuthorized(), getServiceUserHash(), getOrganizationUserHash(), getUserPushId(), getDeviceId(), getServicePins(), getType(), getReason(), getDenialReason());
    }
