...
public class AdvancedAuthorizationResponse {
    ...
    private final AuthorizationResponsePolicy policy;
     ...
     */
    public AdvancedAuthorizationResponse(
     ...
     * @return Auth Response Policy
     */
    public AuthorizationResponsePolicy getPolicy() {
        return policy;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdvancedAuthorizationResponse)) return false;
        AdvancedAuthorizationResponse that = (AdvancedAuthorizationResponse) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(authorizationRequestId);
    }

    @Override
    public String toString() {
        return "AdvancedAuthorizationResponse{" +
    ...
    public enum Reason {
        /**
         * User satisfies all request authPolicy requirements; successfully authenticates with all applicable methods
         */
        APPROVED,

        /**
         * User satisfies all request authPolicy requirements; chooses to deny request rather than proceed with
         * authentication
         */
        DISAPPROVED,

        /**
         * User satisfies all request authPolicy requirements; chooses to deny request because they believe it to be
         * fraudulent in some manner
         */
        FRAUDULENT,

        /**
         * Authenticator fails to satisfy request authPolicy; authentication not allowed
         */
        POLICY,

        /**
         * Authenticator satisfies all request authPolicy requirements, but permission on device prevents auth method
         * verification
         */
        PERMISSION,

        /**
         * Authenticator satisfies all request authPolicy requirements, but user fails to successfully authenticate with
         * all required authentication methods
         */
        AUTHENTICATION,

        /**
         * Authenticator fails to satisfy request authPolicy because authenticator configuration is incompatible with the
         * request authPolicy (i.e. requiring an auth method that is configured to be unavailable to end users)
         */
        CONFIGURATION,
        ...
        /**
         * Authenticator satisfies all request authPolicy requirements, but a sensor issue on device prevents auth method
         * verification
         */
        SENSOR,
